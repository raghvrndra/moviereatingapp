...
import LeftListBarComponent from '../../Components/LeftListBarComponent';
...
const  MoviesContainer = ()=>{
             ...
             const GetDataTrending = async ()=>{
                 ...
                 const {data} = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=220c83b3095a8d723191a3bd38eaa6ed&page=${pageno}&with_genres=&language=en-US&with_genres=${genreforURL}`)
