...
const DetailsContainer = ()=>{
    ...
    const fetchData = async () =>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}?api_key=220c83b3095a8d723191a3bd38eaa6ed&language=en-US`);
          setContent(data);
    ...
    const fetchVideo = async () =>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}/videos?api_key=220c83b3095a8d723191a3bd38eaa6ed&language=en-US`);
    ...
    const creditsFetch = async ()=>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}/credits?api_key=220c83b3095a8d723191a3bd38eaa6ed&language=en-US`);
